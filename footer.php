<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    ...
    <div class="col s2">
      ...
      <p class="bold">
        16-7-31 , devangula street , <br>
        fazulbeg peta , Srikakulam <br> AndhraPradesh, 532005
      </p>
    </div>
    <div class="col s2">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px;">
    <div class="wide-container underline">© 2023 OG Tech PC All rights reserved.   Developed By Sunil & Deepshikha</div>
  </div>
